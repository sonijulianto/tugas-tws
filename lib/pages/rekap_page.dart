...
class RekapPage extends StatefulWidget {
  static const rekapTitle = 'Histori';
...
class _RekapPageState extends State<RekapPage> {
  ...
  void _firstLoad(String token) async {
    ...
    try {
      final res =
          await http.get(Uri.parse('$_baseUrl/absensi/${SignInPage.nip}'));
  ...
  //     try {
  //       final res = await http.get(Uri.parse('$_baseUrl/absensi/121212'),
